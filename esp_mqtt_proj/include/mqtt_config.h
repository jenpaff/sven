...
#define MQTT_HOST            "farmer.cloudmqtt.com" // the IP address or domain name of your MQTT server or MQTT broker ,such as "mqtt.yourdomain.com"
#define MQTT_PORT            10812    // the listening port of your MQTT server or MQTT broker
#define MQTT_CLIENT_ID        "clientID"    // the ID of yourself, any string is OK,client would use this ID register itself to MQTT server
...
#define MQTT_KEEPALIVE        1200     /*second*/
#define MQTT_RECONNECT_TIMEOUT     150    /*second*/
